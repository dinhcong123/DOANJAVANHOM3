...
public class SecurityConfig {
    ...
    private final LogoutSuccessHandler logoutSuccessHandler; // Tiêm CustomLogoutSuccessHandler vào lớp cấu hình này.
    ...
    public SecurityFilterChain securityFilterChain(@NotNull HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/user/**","/css/**", "/js/**", "/images/**").permitAll() // Cho phép truy cập các tệp tĩnh.
                        .requestMatchers( "/movies/**", "/", "/oauth/**", "/register", "/error",
                                "/listphim", "/phimtheotheloai/**", "/phimtheoquocgia/**",
                                "/chitietphim/**", "/xemphim/**", "anhbia/**",
                                "/search**", "/luuphim/**", "/xoaluuphim/**","/random").permitAll()
                ...
                .httpBasic(httpBasic -> httpBasic
                        .realmName("Anime") // Tên miền cho xác thực cơ bản.
                )
